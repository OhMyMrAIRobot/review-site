...
export default {
  content: [
      ...
      "./resources/views/admin/shops/editShop.blade.php",
      "./resources/views/admin/categories/adminCategory.blade.php",
      "./resources/views/admin/categories/addCategory.blade.php",
