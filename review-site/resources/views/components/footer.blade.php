<footer class="bg-gray-800 mt-auto">
    <div class="lg:grid lg:grid-cols-12 gap-8 px-4 lg:px-20 py-4">
        ...
        <div class = "col-span-5 text-white">
            <h3 class="font-bold text-3xl pb-2">@lang('header.title')</h3>
        ...
        <div class = "col-span-3 lg:mt-0 mt-5">
            <h3 class = "font-bold text-white text-3xl pb-2">@lang('footer.quickLinks')</h3>
        ...
        <div class = "col-span-4 lg:mt-0 mt-5">
            <h3 class = "text-white font-bold text-3xl pb-2">@lang('footer.feedback')</h3>
            <form class="flex flex-col gap-3" method="POST" action="{{route('feedback.store')}}">
                ...
                <label>
                    <textarea class = "lg:w-full sm:w-1/2 w-full text-white resize-none px-3 py-2 rounded bg-gray-600 outline-gray-900" rows="4" name = "description" placeholder = "@lang('footer.text')"></textarea>
                </label>
