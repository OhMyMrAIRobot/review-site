...
<head>
    ...
    <title>@lang('register.page')</title>
        ...
        <div class="w-full bg-white rounded-lg shadow dark:border lg:mt-0 max-w-md lg:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method='POST' action="{{route('register.store')}}">
                    @csrf
                    <div>
                        <label for="username" class="block mb-2 text-sm font-medium text-gray-900">@lang('register.usernameLabel')</label>
                        <input type="text" name = "username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                               placeholder="@lang('register.username')" value="{{old('username')}}">
                    </div>

                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900">@lang('register.emailLabel')</label>
                    ...
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900">@lang('register.password')</label>
                    ...
                    <div>
                        <label for="password_c" class="block mb-2 text-sm font-medium text-gray-900">@lang('register.confirm')</label>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="remember" class="font-light text-gray-500 ">@lang('register.remember')</label>
                        </div>
                    </div>
                    ...
                    >@lang('register.title')</button>

                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        @lang('register.haveAcc')
                    </p>
