        ...
        <div class="w-full bg-white rounded-lg shadow dark:border lg:mt-0 max-w-md lg:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method='POST' action="{{route('password.update')}}">
                    ...
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900">@lang('reset.emailLabel')</label>
                    ...
                    <div>
                        <label for="password" class="mb-2 text-sm font-medium text-gray-900">@lang('reset.password')</label>
                    ...
                    <div>
                        <label for="password_c" class="mb-2 text-sm font-medium text-gray-900">@lang('reset.confirm')</label>
