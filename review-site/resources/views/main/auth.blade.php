        ...
        <div class="w-full bg-white rounded-lg shadow dark:border lg:mt-0 max-w-md lg:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method='POST' action="{{route('auth.login')}}">
                    @csrf
                    <div>
                        <label for="username" class="block mb-2 text-sm font-medium text-gray-900">@lang('auth.usernameLabel')</label>
                    ...
                    <div>
                        <label for="password" class="mb-2 text-sm font-medium text-gray-900 flex justify-between">
                            ...
                            <a href="{{route('password.index')}}" class="text-indigo-600 hover:underline">@lang('auth.forgot')</a>
                        </label>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="remember" class="font-light text-gray-500 ">@lang('auth.remember')</label>
                        </div>
                    </div>
